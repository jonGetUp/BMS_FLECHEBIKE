...
* Unit:0.1 °C
* R = NTC 10k, calculated with B=3380K
* Function modified because of ADC 14 bits resolution
* 
* source: http://www.sebulli.com/ntc/
*/
int32_t NTC_table[33] = {
  1906, 1546, 1186, 996, 868, 771, 693, 627, 
  570, 519, 473, 430, 391, 353, 318, 283, 250, 
  217, 185, 153, 121, 89, 56, 22, -13, -51, 
  -91, -136, -187, -247, -325, -443, -561
};
